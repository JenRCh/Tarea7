...
struct LoginView: View {
  @State var userName = ""
  @State var password = ""
  @AppStorage("stored_User") var user = "jennilyn@hotmail.com"
  ...
  @AppStorage("status") var logged = false
    ...
    var body: some View {
        ...
        VStack{
            ...
            Image("logBac").resizable().frame(height: 175.0)
                        
            HStack{
                VStack(alignment: .leading, spacing:12, content:{
                    Text("Login").font(/*@START_MENU_TOKEN@*/.title/*@END_MENU_TOKEN@*/).fontWeight(/*@START_MENU_TOKEN@*/.bold/*@END_MENU_TOKEN@*/).foregroundColor(.black)
                    //Check on the other view
                    
                    Text("Please sign in to continue").foregroundColor(Color.black.opacity(0.5))
                })
                Spacer(minLength: /*@START_MENU_TOKEN@*/0/*@END_MENU_TOKEN@*/)
            }
            .padding(.leading,15)
            HStack{
                Image(systemName: "envelope").font(.title2).foregroundColor(.black).frame(width:35)
            ...
            HStack{
                Image(systemName: "lock")
                    ...
                    .frame(width:35)
                SecureField("PASSWORD", text:$password).autocapitalization(/*@START_MENU_TOKEN@*/.none/*@END_MENU_TOKEN@*/)
            }
            .padding()
            ...
            HStack{
                Text("Ingresar con Face ID").padding()
            }
            HStack{
            ...
            HStack{
                ...
                Text("Registrese aqui").foregroundColor(/*@START_MENU_TOKEN@*/.blue/*@END_MENU_TOKEN@*/)
            }.padding()
